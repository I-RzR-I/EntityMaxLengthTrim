...
set applicationName=EntityMaxLengthTrim
...
set packResultPath=$('..\nuget\')
set packProjectsPath=$('..\src\EntityMaxLengthTrim\EntityMaxLengthTrim.csproj')
set testProjectsPath=$('..\src\tests\EntityModelStringTruncateTest\EntityModelStringTruncateTest.csproj')
